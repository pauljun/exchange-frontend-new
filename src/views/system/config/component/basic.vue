<template>
  <div class="app-container">
    <el-form ref="form" :rules="rules" :model="form">
      ...
      >
        <el-input
          v-model="form.site.map"
          placeholder="请输入红色地图"
          autocomplete="off"
          clearable
        />
      </el-form-item>
      <el-form-item label="云端展厅" :label-width="width">
        <el-input
          v-model="form.site.show"
          placeholder="请输入云端展厅"
          autocomplete="off"
          clearable
        />
      ...
      <el-form-item label="备案号" :label-width="width">
        <el-input
          v-model="form.footer.record_number"
          placeholder="请输入备案号"
          autocomplete="off"
          clearable
        />
      ...
      <el-form-item label="备案链接地址" :label-width="width">
        <el-input
          v-model="form.footer.record_url"
          placeholder="请输入备案链接地址"
          autocomplete="off"
          clearable
        />
      </el-form-item>
